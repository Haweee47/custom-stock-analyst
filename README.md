...
증권사 리포트는 대형주에 쏠려 있습니다. 시가총액 1천억 원 미만 종목은 88%가
최근 3개월 안에 나온 리포트가 없습니다. 이 서비스는 국내·미국·일본·중국
전 종목(17,395개)에 대해, 오늘 데이터로 리포트를 즉시 만들어 줍니다.

종목도 관점도 직접 골라 담는다는 뜻에서 '셀프바'입니다.
...
- **캐시 수명은 관점마다 다릅니다.** 펀더멘탈 14일, 종합 7일, 이슈·트렌드 5일,
  기술적 3일입니다. 재무는 분기에 한 번 바뀌지만 주가 지표는 매일 움직이기 때문입니다.
